...
#[derive(
    Queryable, QueryableByName, Selectable, Identifiable, Debug, Default, Serialize, Deserialize,
)]
...
#[derive(
    Queryable, Selectable, Identifiable, Associations, Debug, Default, Serialize, Deserialize,
)]
