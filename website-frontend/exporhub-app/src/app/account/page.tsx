        ...
        <Suspense>
          <div className='grid auto-rows-auto size-full overflow-auto'>
            ...
            <main className='flex flex-col md:flex-row items-center row-span-1'>
              <AccountTab sessionUserId={result.userId} followings={followings} favouriteProjects={favouriteProjects} user={user} projects={projects} projectNotifications={projectNotifications} />
            </main>
            <FooterComponent />
          </div>
        </Suspense>
