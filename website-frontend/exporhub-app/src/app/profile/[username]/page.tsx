      ...
      return (
        <div className='grid auto-rows-auto size-full overflow-auto'>
          ...
          <main className='flex flex-col md:flex-row items-center row-span-1'>
            <ProfileTabs isFollowed={isFollowed} user={user} profileUserId={user.user_id} sessionUserId={result.userId} followings={followings} projects={projects} projectNotifications={projectNotifications} favouritesArr={favouritesArr} favouritedProjectsArr={favouritedProjectsArr} favouriteProjects={favouriteProjects} />
          </main>
          <FooterComponent />
        </div>
      )
