    ...
    return (
        <div className='flex-[0_0_40%]'>
            <div className='min-w-[25rem] bg-gradient-to-b from-[var(--border-color)] to-pink-900 rounded-2xl p-[1px]'>
                <div className='flex flex-col items-center py-10 gap-8 rounded-2xl bg-[var(--background)]'>
                    <div className='text-2xl'>Send a password reset link to your email address</div>
