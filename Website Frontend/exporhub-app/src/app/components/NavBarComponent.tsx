    ...
    return (
      <nav className='flex flex-col justify-between h-[150px] border-b-[1px] border-b-pink-200 dark:border-b-pink-900'>
        ...
        <div className='flex relative bottom-[1.8rem] text-lg'>
          ...
          <div id='projects-tab' className='absolute left-[5.75rem] border rounded-full z-20 transition-colors duration-500 ease-in-out border-pink-300 bg-pink-200 dark:border-pink-800 dark:bg-pink-950'>
            <Link href={"/account?tab=projects"} className='px-8'>
              Projects
            </Link>
          </div>
          <div id='favourites-tab' className='absolute left-[12.5rem] border rounded-full z-10 transition-colors duration-500 ease-in-out border-pink-300 bg-pink-200 dark:border-pink-800 dark:bg-pink-950'>
            <Link href={"/account?tab=favourites"} className='px-8'>
              Favourites
            </Link>
          </div>
          <div id='following-tab' className='absolute left-[20.25rem] border rounded-full z-0 transition-colors duration-500 ease-in-out border-pink-300 bg-pink-200 dark:border-pink-800 dark:bg-pink-950'>
            <Link href={"/account?tab=following"} className='px-8'>
              Following
            </Link>
          </div>
        </div>
