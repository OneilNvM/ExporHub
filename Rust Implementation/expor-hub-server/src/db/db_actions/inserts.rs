...
pub fn insert_like(conn: &mut MysqlConnection) -> Result<Option<Like>, anyhow::Error> {
...
pub fn insert_dislike(conn: &mut MysqlConnection) -> Result<Option<Dislike>, anyhow::Error> {
